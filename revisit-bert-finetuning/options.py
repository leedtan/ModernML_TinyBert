...
def get_parser():
    ...
    parser.add_argument(
        "--save_best",
        action="store_true",
        help="Set this flag if you want to save the early stop model.",
    )
    parser.add_argument(
        "--save_last",
        action="store_true",
        help="Set this flag if you want to save the last model.",
    )
    parser.add_argument(
        "--train_batch_size",
        default=0,
    ...
    parser.add_argument(
        "--warmup_ratio", default=0, type=float, help="Linear ratio over total steps."
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--logging_steps", type=int, default=0, help="Log every X updates steps."
    )
    parser.add_argument(
        "--num_loggings",
        type=int,
        default=0,
        help="Total amount of evaluations in training.",
    )
    parser.add_argument(
        "--save_steps",
        type=int,
    ...
    # Added by our paper
    parser.add_argument(
        "--use_bertadam", action="store_true", help="No bias correction"
    )
    parser.add_argument(
        "--use_torch_adamw", action="store_true", help="Use pytorch adamw"
    )
    parser.add_argument(
        "--downsample_trainset",
        default=-1,
        type=int,
        help="down sample training set to this number.",
    )
    parser.add_argument(
        "--resplit_val",
        default=0,
